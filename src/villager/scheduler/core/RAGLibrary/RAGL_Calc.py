...
class RAGEmbeddingWork:
    def __init__(self):
        ...
        self.vectorizer = TfidfVectorizer()  # Calculate query TF-IDF vector (text frequency)
    ...
    #         combined_score = tfidf_weight * tfidf_score + nlp_weight * nlp_score  # Calculate weighted score
